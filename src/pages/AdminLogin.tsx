      ...
      >
        <div className="text-center">
          <motion.div
            ...
            className="mx-auto h-16 w-16 bg-white rounded-full flex items-center justify-center mb-6"
          >
        ...
        >
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p>
                <strong>Username:</strong> attar.attar
              </p>
              <p>
                <strong>Password:</strong> attar.attar
              </p>
            </div>
          </div>
        </motion.div>
